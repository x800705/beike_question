<template>
	<view>
		...
		<uni-list v-for="(item, index) in que_list" :key="index" class="list">
		    ...
		    <view>{{item[3]}}</view>
			<view :class="item[8] === 0? 'right' : null">A:&nbsp&nbsp{{item[4]}}</view>
			<view :class="item[8] === 1? 'right' : null">B:&nbsp&nbsp{{item[5]}}</view>
			<view :class="item[8] === 2? 'right' : null">C:&nbsp&nbsp{{item[6]}}</view>
			<view :class="item[8] === 3? 'right' : null">D:&nbsp&nbsp{{item[7]}}</view>
		</uni-list>  
